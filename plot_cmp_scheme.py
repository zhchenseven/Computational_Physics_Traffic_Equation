...
for i in xrange(len(scheme_lst)):
    ...
    Plot.plot_cmp_scheme(scheme_str)

main_fd_name = 'scan_F_'+scheme_lst[0]
Plot.set_main_fd_ctrl(main_fd_ctrl, main_fd_name)
scheme_str = scheme_lst[0]
suf_string='_ini_di'
y_max=0.11
Plot.plot_cmp_scheme(scheme_str,suf_string,y_max)

main_fd_name = 'scan_F_'+scheme_lst[1]
Plot.set_main_fd_ctrl(main_fd_ctrl, main_fd_name)
scheme_str = scheme_lst[1]
suf_string='_ini_di'
y_max=0.11
Plot.plot_cmp_scheme(scheme_str,suf_string,y_max)


main_fd_name = 'scan_F_'+scheme_lst[2]
Plot.set_main_fd_ctrl(main_fd_ctrl, main_fd_name)
scheme_str = scheme_lst[2]
suf_string='_ini_di'
y_max=0
Plot.plot_cmp_scheme(scheme_str,suf_string,y_max)
